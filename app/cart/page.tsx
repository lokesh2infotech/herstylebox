...
export default function CartPage() {
  ...
  const orderViaWhatsApp = async (e: React.FormEvent) => {
    e.preventDefault()
    setIsSubmitting(true)

    try {
      // 1. Ping the backend to save the order to Postgres
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-6 mt-6">
                ...
                <form onSubmit={orderViaWhatsApp} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center px-6 py-4 mt-6 bg-green-600 dark:bg-green-500 text-white dark:text-gray-900 rounded-lg hover:bg-green-700 dark:hover:bg-green-600 transition-colors font-medium disabled:opacity-50"
                  >
                    {isSubmitting ? (
                      <div className="animate-spin rounded-full h-6 w-6 border-t-2 border-b-2 border-white dark:border-gray-900 mr-2"></div>
                    ) : (
